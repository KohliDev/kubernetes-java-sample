...
. Expose the above created nginx pod with help of services
+
[source, text]
----
...
The nginx server can be accessed at http://172.17.0.2:80 or http://172.17.0.3:80 as per your Endpoint IP address.
